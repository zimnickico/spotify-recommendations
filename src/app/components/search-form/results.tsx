...
export function SearchResults({
  ...
  return (
    <motion.div className="relative w-[fill-available] z-10 transition-all grow pt-10 pb-2 px-2 -mt-9 z-10 overflow-hidden border-[1px] bg-gray-100/40 backdrop-blur rounded-xl rounded-b-3xl text-md flex flex-col">
